...
Route::prefix('siswa')->name('siswa.')->group(function () {
    ...
    Route::post('/import', [SiswaController::class, 'importCSV'])->name('import');
    Route::get('/export-template', [SiswaController::class, 'exportCSVTemplate'])->name('exportTemplate');
   ...
   Route::prefix('penilaian')->name('penilaian.')->group(function () {
    ...
    Route::delete('/nilai/{id}', [NilaiController::class, 'destroy'])->name('nilaidestroy');

...
class kelasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('penilaian.kelas.store')->with('success', 'Kelas berhasil ditambahkan.');
    }
       ...
       public function edit($id)
{
    ...
    public function update(Request $request, Kelas $kelas , $id)
    {
        ...
        return redirect()->route('penilaian.kelas.index')->with('success', 'Kelas berhasil diperbarui.');
    }

    public function destroy(Kelas $kelas)
    {
        $kelas->delete();
        return redirect()->route('penilaian.kelas.index')->with('success', 'Kelas berhasil dihapus.');
    }

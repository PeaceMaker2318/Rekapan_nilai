    ...
    @else
        <tr>
            ...
            <a href="#" class="btn btn-success btn-sm" data-bs-toggle="modal"
               data-bs-target="#tambahNilaiModal" data-siswa-id="{{ $s->id }}">
               Tambah Nilai
            </a>
            </td>
        </tr>
    ...
    <form action="{{ route('penilaian.nilaistore') }}" method="POST">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tambahNilaiModalLabel">Tambah Nilai Siswa</h5>
...
document.addEventListener('DOMContentLoaded', function () {
  const tambahButtons = document.querySelectorAll('[data-siswa-id]');

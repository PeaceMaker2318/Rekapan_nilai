    ...
    <div class="card-body">
        ...
        <div class="d-flex gap-2 mb-3">
            <!-- Tombol untuk membuka modal -->
                   @if(auth()->check() && auth()->user()->role != 'guru' && auth()->user()->role != 'guru_pai' && auth()->user()->role != 'kepsek' )
            ...
            <a href="{{ route('siswa.exportTemplate') }}" class="btn btn-outline-primary">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            ...
                            <a href="{{ route('siswa.exportTemplate') }}" class="btn btn-outline-primary">Download template disini</a>
                        </div>
                    </div>
                    <div class="mb-3">
